                        ...
                        <main className="flex-grow bg-gray-100">
                            <div class="relative grow px-4 py-6" role="presentation">
                                <div class="py-12">
                                    ...
                                    <p class="mt-8 text-center text-lg text-gray-500">Looks like you haven't enrolled in any interactive course.<br /><a class="font-semibold text-indigo-500 underline-offset-2 hover:underline" href="/courses">Browse all interactive courses</a>.</p>
                                </div>
                            </div>
                        </main>
